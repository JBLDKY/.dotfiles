...
=====================================================================
rst==================== READ THIS BEFORE CONTINUING ====================
=====================================================================
...
require('lazy').setup({
  ...
  -- python debugging
  {
    ...
    keys = {
      { "<leader>llp", "<cmd>debugpy toggle<cr>", desc = "NeoTree" },
    },
  },
...
-- Relative linenumbers for jumping
...
-- set background (for gruvbox theme)
...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>lN', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic message' })
vim.keymap.set('n', '<leader>ln', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic message' })
vim.keymap.set('n', '<leader>lo', vim.diagnostic.open_float, { desc = 'Open floating diagnostic message' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>lt', require('telescope.builtin').lsp_type_definitions, 'Type definition')
